...
object PlayGameFlow {
    ...
    class Initiator(val linearId: UniqueIdentifier, val move: IntArray) : FlowLogic<SignedTransaction>() {
        ...
        override fun call(): SignedTransaction {
            ...
            // Let's flip who's go it is next
            val currentStateOfPlay = ticTacToeState.board
            val newStateOfPlay = currentStateOfPlay[]


            val ticTacToeStateWithPlay = ticTacToeState.copy(activePlayer = ticTacToeState.dormantPlayer, dormantPlayer = ticTacToeState.activePlayer)
            // Let's apply the play
